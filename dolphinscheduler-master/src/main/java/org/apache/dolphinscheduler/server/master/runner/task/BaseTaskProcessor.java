...
public abstract class BaseTaskProcessor implements ITaskProcessor {
    ...
    public void init(@NonNull TaskInstance taskInstance, @NonNull ProcessInstance processInstance) {
        ...
        tenantMapper = SpringApplicationContext.getBean(TenantMapper.class);
        userMapper = SpringApplicationContext.getBean(UserMapper.class);
    ...
    public String queryTenantCodeByRes(Resource res) {
