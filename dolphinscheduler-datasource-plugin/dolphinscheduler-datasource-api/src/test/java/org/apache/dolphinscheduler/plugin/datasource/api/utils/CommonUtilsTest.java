...
@SuppressStaticInitializationFor(value = {"org.apache.dolphinscheduler.spi.utils.PropertyUtils",
...
public class CommonUtilsTest {
    ...
    public void testGetKerberosStartupState() {
        ...
        PowerMockito.when(PropertyUtils.getUpperCaseString(Constants.RESOURCE_STORAGE_TYPE))
