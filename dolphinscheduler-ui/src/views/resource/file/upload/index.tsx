...
import { NButton, NForm, NFormItem, NInput, NUpload, UploadFileInfo } from 'naive-ui'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const handleFileList = (fileList: UploadFileInfo[]) => {
      state.uploadForm.fileList = fileList
    }
        ...
        <NForm rules={this.rules} ref='uploadFormRef'>
          ...
          <NFormItem label={t('resource.file.upload_files')} path='file'>
            <NUpload
              ...
              on-update:file-list={this.handleFileList}
              class='btn-upload'
              max={100}
              multiple={true}
