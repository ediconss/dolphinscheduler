...
export default defineComponent({
  ...
  setup() {
    ...
    const handleRefreshResource = () => {
      // console.log(fileStore.currentDir)
      refreshResource({ path: fileStore.currentDir }).then(() => {
        ...
        <Card>
          <NSpace justify='space-between'>
            <NButtonGroup size='small'>
              ...
              <NButton onClick={handleRefreshResource} class='btn-upload-file'>
                {t('resource.file.refresh')}
              </NButton>
            </NButtonGroup>
            <NSpace>
              <NInput
