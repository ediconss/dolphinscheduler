...
public class DependentUtilsTest {
    ...
    public void testMinute() {
        List<DateInterval> lastMinutesInterval = DependentDateUtils.getLastMinutesInterval(new Date(), 30);
        for (DateInterval dateInterval : lastMinutesInterval) {
            logger.info("start {} end {}", dateInterval.getStartTime(), dateInterval.getEndTime());
        }
    }
