...
public class LoggerController extends BaseController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "filter", value = "FILTER", required = false, dataTypeClass = String.class, example = "INFO")
    })
    ...
    public Result<ResponseTaskLog> queryLog(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
        ...
        return loggerService.queryLog(taskInstanceId, skipNum, limit, filter);
    }
    ...
    public Result<String> queryLog(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
                                   ...
                                   @RequestParam(value = "limit") int limit,
                                   @RequestParam(value = "filter", required = false) String filter) {
        return returnDataList(loggerService.queryLog(loginUser, projectCode, taskInstanceId, skipNum, limit, filter));
    }
